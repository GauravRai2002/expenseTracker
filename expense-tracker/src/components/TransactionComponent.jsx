...
function TransactionComponent({ transactionData }) {
    ...
    return (
        <>
            <div className="card w-5/6 md:w-4/5 bg-base-300 shadow-xl py-4">
                <div className="flex flex-row items-center justify-evenly">
                    <div className="card-title w-1/2 items-center justify-center text-center flex-col">
                        {transactionData.remark} 
                        <div className='text-xs'>{transactionData.date?transactionData.date: '' }</div>
                    </div>
                    <div className='w-1/2 flex items-center justify-center gap-3'>
                        ...
                        <div ref={balanceRef} className='font-bold text-2xl'>{transactionData.amount < 0 ? -1 * transactionData.amount : transactionData.amount}</div>
                    </div>
                </div>
            </div>
        </>
